<?php
    ...
    $user_check_query = "SELECT email FROM user WHERE email = '$tmpemail';";
    $results = mysqli_query($db, $user_check_query);
    $db_output = mysqli_fetch_assoc($results);
    
    if(empty($db_output['email'])) {array_push($_SESSION['outputmsg'], "E-Mail unknown! Please register first!");};
